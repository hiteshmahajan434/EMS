...
import { dummyEmployeeAttendance, DEPARTMENTS, getWorkingHoursDisplay } from "../../assets/assets";
      ...
      {/* Stats */}
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
            <div className="summary-pill">
                <div>
                    <p className="text-xs text-slate-600 uppercase tracking-wide font-medium">Present</p>
                    <p className="text-lg font-semibold text-emerald-600 mt-0.5">{presentCount}</p>
                </div>
            </div>
            <div className="summary-pill">
                <div>
                    <p className="text-xs text-slate-600 uppercase tracking-wide font-medium">Working</p>
                    <p className="text-lg font-semibold text-blue-600 mt-0.5">{workingCount}</p>
                </div>
            </div>
            <div className="summary-pill">
                <div>
                    <p className="text-xs text-slate-600 uppercase tracking-wide font-medium">Absent</p>
            ...
            <div className="summary-pill">
                <div>
                    <p className="text-xs text-slate-600 uppercase tracking-wide font-medium">On Leave</p>
                  ...
                  <tr key={record.id || record._id}>
                    ...
                    <td className='px-6 py-4'>
                        ...
                        className={`badge ${ record.status === "Present"
                            ? "badge-success" 
                            : record.status === "Working" ? "badge-info" : record.status === "On Leave" ? "badge-warning" : "badge-danger"
                        }`}
                        >
                        {record.status}
                        </span>
