...
import {
    CalendarIcon, ChevronDownIcon, ChevronRightIcon, DollarSignIcon, FileTextIcon, LayoutGridIcon, LogOutIcon, MenuIcon, SettingsIcon,
    UserIcon, UsersIcon, ClipboardCheckIcon, WalletCardsIcon, XIcon
} from "lucide-react";
...
const SideBar = () => {
    ...
    return (
        <>
            ...
            {/* Sidebar Mobile */}
            <aside className={`lg:hidden fixed inset-y-0 left-0 w-72 bg-slate-900 text-white z-50 flex flex-col transform transition-transform duration-300 
